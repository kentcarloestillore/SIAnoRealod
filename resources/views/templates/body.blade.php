<div class="flex justify-between">
    ...
    <div class="flex gap-5">
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" id="openModalButton" hx-get='api/student/create'
        hx-target='#addModal' hx-swap='innerHTML'>Add</button>
    </div>
</div>
<hr>
<div id="student_list"
